...
<html lang='nl'>
    ...
    <body>
        <h2>
            ...
            <form method="post" action="<c:url value='/boeken'/>">
                <table>
                    <tr><th>Datum </th><th>Titel</th><th>Uitvoerders</th><th>Prijs</th><th>Plaatsen</th><th><input type="submit" value="Verwijderen" ${hideverwijderen}> </th></tr>
                    <c:forEach var='a' items='${mandje}'>
                        ...
                        <tr><td>${formattedDate}</td>
                            ...
                            <td align="center"><input type="radio" value="${a.value.voorstelling.id2}" name="id">
                            </td>
                        </tr>
                    </c:forEach> 
                </table>
